      ...
      <CContainer className="border-bottom px-4" fluid>
        ...
        <CHeaderNav>
          ...
          <CDropdown variant="nav-item" placement="bottom-end">
            <CDropdownToggle caret={false}>{colorMode === 'dark' ? <CIcon icon={cilMoon} size="lg" /> : colorMode === 'auto' ? <CIcon icon={cilContrast} size="lg" /> : <CIcon icon={cilSun} size="lg" />}</CDropdownToggle>
            <CDropdownMenu>
              <CDropdownItem active={colorMode === 'light'} className="d-flex align-items-center" as="button" type="button" onClick={() => setColorMode('light')}>
              ...
              <CDropdownItem active={colorMode === 'auto'} className="d-flex align-items-center" as="button" type="button" onClick={() => setColorMode('auto')}>
